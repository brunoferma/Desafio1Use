...
import com.example.usedesafioum.databinding.FragmentForthBinding
...
class ForthFragment : Fragment() {
    ...
    private val args: ForthFragmentArgs by navArgs()
        ...
        binding.NextBtn.setOnClickListener {
            if (binding.RadioBtn1.isChecked) {
                findNavController().navigate(
                    ForthFragmentDirections.actionForthFragmentToFifthFragment(acertos))
            } else if (binding.RadioBtn2.isChecked) {
                findNavController().navigate(
                    ForthFragmentDirections.actionForthFragmentToFifthFragment(acertos))
            } else if (binding.RadioBtn3.isChecked) {
